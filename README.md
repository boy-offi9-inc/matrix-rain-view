...
[![JitPack](https://jitpack.io/v/boy-offi9-inc/matrix-rain-view.svg)](https://jitpack.io/#boy-offi9-inc/matrix-rain-view)
![minSdk 21](https://img.shields.io/badge/minSdk-21-brightgreen)
...
- Android `minSdk` 21+
- AndroidX
- Kotlin (Java consumers can still use the view — it's a standard `View` subclass with no Kotlin-only API surface)
